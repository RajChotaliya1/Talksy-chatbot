      ...
      <div className="relative h-full flex-1 px-2.5 py-1.5 md:px-3.5 md:py-2.5 rounded-xl bg-white text-black border border-purple-200 flex flex-col">
        ...
        >
          {selectedChatIndex === null || currentChat.messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center text-center h-full text-purple-700 font-serif font-semibold italic">
              <SiLivechat className="text-purple-400 text-4xl mb-2 animate-pulse" />
              <p className="text-purple-700 text-lg font-serif font-semibold italic">
            ...
            <>
              {currentChat.messages.map((msg, index) => (
                ...
                >
                  <div
                    className={`group px-3 text-sm md:text-md shadow ${
                      msg.sender === "user"
              ...
              {error && (
                <p className="text-red-600 italic mt-2">Error: {error}</p>
              )}
            </>
          )}
        </div>
