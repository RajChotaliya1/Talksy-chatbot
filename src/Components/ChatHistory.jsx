  ...
  return (
    <>
      <div className="md:hidden flex justify-between w-full items-center p-2.5 bg-purple-50 ">
        <div className="flex w-full justify-between items-center px-2">
          <button
            ...
            className="px-2 py-2 rounded-full text-sm bg-gradient-to-r from-purple-500 to-pink-500 text-white hover:bg-pink-600 transition cursor-pointer hover:brightness-110 active:scale-95"
          >
            <FaPlus />
          </button>
          <h1 className="text-xl font-bold italic text-purple-700 drop-shadow-sm">
            <SiLivechat className="inline w-5 h-5 mr-0.5 mb-0.5" /> Talksy
          </h1>

          <div className="flex items-center space-x-2.5">
            <CgProfile
              className="cursor-pointer size-5.5 text-purple-600"
              onClick={profileFun}
            />
            {!isOpen && (
              <button
      ...
      <div
        ...
        `}
      >
        <div className="py-3 px-3.5 md:py-2.5 w-full h-full rounded-xl bg-white text-black border border-purple-200 relative flex flex-col">
          <button
          ...
          <h1 className="text-lg sm:text-xl font-bold italic text-purple-700 mb-4 drop-shadow-sm">
              ...
              <ul>
                {reversedChats.map((chat, revIndex) => {
                  ...
                  return (
                    <li
                      key={index}
                      className={`p-3 mb-2 rounded relative ${
